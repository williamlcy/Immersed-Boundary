...
Line(8) = {7, 4};
//+
Transfinite Curve {-8} = 120 Using Progression 0.98;
//+
Transfinite Curve {3} = 120 Using Progression 0.98;
//+
Transfinite Curve {7, -4} = 120 Using Progression 0.98;
//+
Transfinite Curve {1, -2, 5, -6} = 120 Using Progression 0.98;
//+
